...
public class WorldManager : MonoBehaviour
{
    ...
    void SpawnSmallIsland ()
    {
        ...
        Vector3 pos = new Vector3(Random.Range(-0.5f, 0.5f), 300f, Random.Range(-0.5f, 0.5f)) + islandObj.transform.position;

        RaycastHit hit;

        if (Physics.Raycast(pos, Vector3.down, out hit, Mathf.Infinity, ~Physics.IgnoreRaycastLayer, QueryTriggerInteraction.Ignore))
        {
        ...
        Debug.DrawLine(pos, hit.point, Color.red, 20f);
